...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Transaction amount', minimum: 0 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Points earned from transaction', minimum: 0, required: false }),
